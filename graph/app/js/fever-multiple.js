...
var render = function(containerWidth) {
    ...
    _.each(_.take(dataSeries, 20), function(d, i) {
...
var renderLineChart = function(config) {
    ...
    var colNum = 1 + (config.chartNum % 2);
    var rowNum = Math.ceil(config.chartNum / 2);
    console.log(rowNum);
    ...
    var colorScale = d3.scale.ordinal()
        .domain(_.pluck(dataSeries, 'name'))
        .range([COLORS[0]]);
    ...
    var chartWrapper = containerElement.append('div')
        .attr('class', 'graphic-wrapper multi-fever');

    chartWrapper.append('h3')
        .attr('class', 'multi-fever-label')
